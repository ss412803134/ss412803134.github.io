...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js13 .slide0');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/mei-nu_fotor-780.jpg':'images/mei-nu_fotor-390.jpg');



var e=document.querySelector('.js14');e.setAttribute('src',(dpi>1)?'images/ying_-153661473--670.jpg':'images/ying_-153661473--335.jpg');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
initMenu($('#m6')[0]);
$('.s99').Stickyfill();
$('.js13 .slider').slick({lazyLoad: 'ondemand',slidesToShow: 1,slidesToScroll: 1,overflow: 'visible',fade: true,slide: 'div',cssEase: 'linear',speed: 200,dots: true,arrows: true,infinite: true,autoplay: true,pauseOnHover: true,autoplaySpeed: 1550});
});